...
function ShippingInfo ({FormData, setFormData}) {
 ...
 <input  placeholder='Enter Email' autoComplete="off" className="text-gray-600 dark:text-gray-400 focus:outline-none  dark:border-gray-700 dark:bg-gray-800 bg-white font-normal w-3/4 md:w-2/4 mb-4 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border shadow"
