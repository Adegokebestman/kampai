...
const Order = () => {
	...
	return (
		<div className='btn-count mt-24 ml-2 md:mt-10'>
			<span className='border rounded-full border-white sidebar p-4 font-semibold text-black'>
				Cart items
			</span>
				...
				<div className='flex justify-center items-center absolute'>
					<div className='flex m-3 flex-wrap justify-center gap-8 items-center '>
						...
						<div className=' flex justify-between'>
							<Link to='../Inventory'>
								<button class='py-2 px-10 mr-10 md:mr-20 text-xl md:text-2xl bg-[#FF7E20] text-[#ffffff] font-semibold border border-[#FF7E20] rounded hover:bg-[#FF7E20] hover:text-white hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0'>
									Add Item
								</button>
							</Link>
